...
(document.querySelectorAll("[toast-list]") ||
  ...
  (document.writeln(
    "<script type='text/javascript' src='../../static/assets/libs/toastify-js/toastify.js'></script>"
  ),
  document.writeln(
    "<script type='text/javascript' src='../../static/assets/libs/choices.js/public/assets/scripts/choices.min.js'></script>"
  ),
  document.writeln(
    "<script type='text/javascript' src='../../static/assets/libs/flatpickr/flatpickr.min.js'></script>"
  ));
